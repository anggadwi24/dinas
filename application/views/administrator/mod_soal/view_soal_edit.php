                                ...
                                <form class="needs-validation"  id="formAdd">
                                  <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                      ...
                                      <textarea id="summernote" name="soal"><?= $row['quiz']?></textarea>
                                    ...
                                    <div class="col-md-12 mb-3">
                                      ...
                                      <small class="text-info">Isi Jika ingin mengganti</small>
                                      
                                    </div>
                                    <div class="col-md-12 mb-3">
                                      <label for="validationCustomUsername">Answer A</label>
                                     
                                       <textarea class="summernote" name="answer_a" required><?= $row['answer_a']?></textarea>
                                    ...
                                    <div class="col-md-12 mb-3">
                                      <label for="validationCustomUsername">Answer B</label>
                                       ...
                                       <textarea class="summernote" name="answer_b" required><?= $row['answer_b']?></textarea>
                                    ...
                                    <div class="col-md-12 mb-3">
                                      <label for="validationCustomUsername">Answer C</label>
                                       ...
                                       <textarea class="summernote" name="answer_c" required><?= $row['answer_c']?></textarea>
                                    ...
                                    <div class="col-md-12 mb-3">
                                      <label for="validationCustomUsername">Answer D</label>
                                       ...
                                       <textarea class="summernote" name="answer_d" required><?= $row['answer_d']?></textarea>
                                    ...
                                    <div class="col-md-12">
                                     ...
                                     <div class="col-md-12 mb-3">
                                      <label for="validationCustomUsername">Correction</label>
                                       ...
                                       <textarea class="summernote" name="correction" required><?= $row['correction']?></textarea>
                                  ...
                                  <input type="hidden" name="oldfoto" value="<?= $row['image']?>">
                                  <input type="hidden" name="id" value="<?= $this->encrypt->encode($row['id_quiz'],keys())?>">
  ...
  $(document).ready(function(){
     ...
     $("#formAdd").on('submit', function(e){
        ...
        $.ajax({
            ...
            type: 'POST',
            url:"<?= base_url('administrator/doEditSoal') ?>",
