                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td><center>
                                ...
                                ";?>
                                <?php if ($row[status] == 'n'){?>
                                  <a class='btn btn-primary btn-xs' title='Approve Reseller' href='<?php echo base_url('administrator/aprrove_reseller').'/'.$row[id_reseller] ?>'><span class='glyphicon glyphicon-ok'></span></a>
                                <?php }?>
                      <?php echo "
