...
<?php 
    echo "<div class='col-md-12'>
              ...
              $disk = $this->model_app->edit('rb_produk_diskon',array('id_produk'=>$rows['id_produk']))->row_array();
               $jual = $this->model_reseller->jual_admin('1',$rows['id_produk'])->row_array();
              $beli = $this->model_reseller->beli_admin('1',$rows['id_produk'])->row_array();
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <input type='hidden' name='stokold' value='$rows[stok]'>
                    <tr><th scope='row'>Stok</th>                <td><input style='display:inline-block; width:80px; color:red' type='number' class='form-control' value='".($beli['beli']-$jual['jual'])."' disabled> + <input style='display:inline-block; width:80px' type='number' class='form-control' name='stok'> </td></tr>
