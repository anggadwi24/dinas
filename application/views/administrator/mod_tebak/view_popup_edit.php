                   ...
                   <a href="<?= base_url('administrator/popup')?>" class="btn btn-primary mt-2 mb-5">KEMBALI</a>
                    <form id="uploadForm" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <h6><?= ucfirst($row['type'])?></h6>
                            <?php if($row['type'] == 'video'):?>
                            <video width="320" height="240" controls>
                                                  <source src="<?= base_url('asset/popup/').$row['file'] ?>" type="video/mp4">
                                               
                                                </video>
                            <?php else:?>
                                <img src="<?= base_url('asset/popup/').$row['file']?>" class="img-fluid">
                            <?php endif;?>
                          </div>
                          <div class="col-lg-12 form-group">
                            ...
                            <input type="hidden" name="old" value="<?= $row['file']?>">
                            <input type="hidden" name="id" value="<?= $row['id_popup']?>">
                          </div>
                         <div class="col-lg-12">
                                   ...
                                   <div class="col-md-12">
                                    <button class="btn btn-primary " style="width:100%" id="btnAdd">EDIT</button>
    ...
    $(document).ready(function(){
        ...
        $("#uploadForm").on('submit', function(e){
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?= base_url('administrator/updatePopup')?>',
