<center>  <h1 class="h3 mb-2 text-gray-800">REKAP KEHADIRAN PTT PADA BIRU UMUM PERLENGKAPAN BULAN  <?= $bulan ?> TAHUN <?= $tahun?></h1></center>
<br>
                                <table width="100%" border="1" >
                                    <thead style="background-color: #5cce5c">
                                        <tr>
                                            ...
                                            <th rowspan="2" width="10%">BAGIAN</th>
                                        ...
                                        <?php $no = 1; foreach($record->result_array() as $row){?>
                                            ...
                                            <tr>
                                                <td align="center"><?=$no;?></td>
                                                 ...
                                                 <td align="center"><?= ucfirst($row['nama_bagian']);?></td>
