                ...
                <form action="<?= base_url('administrator/form')?>" method="post">
                   <div class="row pt-3 pb-3">
                     ...
                     <?php 
                        ...
                        <?php
                            ...
                            echo "<input type='hidden' name='cabang' value='".$cbg."'>";
                        }
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                             ...
                             $link = 'administrator/form/add';
                              ...
                              if($c > 0){
                              ?>
                                                  <div class="my-3"><a href="<?= base_url('administrator/form/add')?>" class="btn btn-primary">TAMBAH FORM</a></div>
                                    ...
                                    <tbody>
                                        <?php $no = 1; foreach($record->result_array() as $row){
                                          ...
                                          ?>
                                            ...
                                            <tr class='clickable-row' data-href='<?= base_url('administrator/form/detail?id=').encode($row['id_form'])?>'>
