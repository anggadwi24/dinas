 ...
 $link = 'administrator/absen/add';
  ...
  if($c > 0){
  ?>
                   <div class="my-3"><a href="<?= base_url('administrator/absen/add')?>" class="btn btn-primary">Tambah Absen</a></div>
                                    ...
                                    <tbody>
                                        <?php $no = 1; foreach($record->result_array() as $row){
                                          ...
                                          ?>
                                            ...
                                            <tr class='clickable-row' data-href='<?= base_url('administrator/absen/detail?id=').encode($row['id_absensi'])?>'>
