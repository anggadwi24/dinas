            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown messages-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <i class="fa fa-envelope-o"></i> Chat Masuk
            
                  <span class="label label-success" id="totChat1"></span>
                </a>
                <ul class="dropdown-menu">
                  <li class="header">Kamu memiliki <span id="chatTot"></span> Chat Masuk</li>
                  <li>
                    <ul class="menu" id="chatCome">
                      <!-- <?php 
                  ...
                  <li class="footer"><a href="<?php echo base_url().$this->uri->segment(1); ?>/chat">See All Messages</a></li>
                </ul>
              </li>
              <?php } ?>
              <li>
