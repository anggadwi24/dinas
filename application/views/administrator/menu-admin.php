        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo base_url().$this->uri->segment(1); ?>/konsumen"><i class="fa fa-user"></i> <span>Data User</span></a></li>
       <!--      <li class="treeview">
              <a href="#"><i class="fa fa-puzzle-piece"></i> <span>Tebak Angka</span></a>
              <ul class="treeview-menu">
                  <?php 
                    $cek=$this->model_app->umenu_akses("angka",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url().$this->uri->segment(1)."/angka'><i class='fa fa-circle-o'></i> Data Angka</a></li>";
                    }
                  ...
                  ?>
                   <li class="treeview">
                <a href="#"><i class="fa fa-circle-o"></i> Tebak Angka <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                <ul class="treeview-menu">
                  <?php 
                    $cek=$this->model_app->umenu_akses("tebakangka",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url().$this->uri->segment(1)."/tebakangka/dua'><i class='fa fa-circle-o'></i> Dua Angka</a></li>";
                    }

                    $cek=$this->model_app->umenu_akses("tebakangka",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url().$this->uri->segment(1)."/tebakangka/tiga'><i class='fa fa-circle-o'></i> Tiga Angka</a></li>";
                    }
                    $cek=$this->model_app->umenu_akses("tebakangka",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url().$this->uri->segment(1)."/tebakangka/empat'><i class='fa fa-circle-o'></i> Empat Angka</a></li>";
                    }
                    ?>
                  </ul>
                </li>
           ...
           <!--  <li><a href="<?php echo base_url().$this->uri->segment(1); ?>/absen"><i class="fa fa-users"></i> <span>Absen</span></a></li> -->
              <li><a href="<?php echo base_url().$this->uri->segment(1); ?>/chat"><i class="fa fa-comment"></i> <span>Chat <span class="badge btn btn-danger" id="totChat" style="font-size:10px">0</span></span></a></li>
            <li><a href="<?php echo base_url().$this->uri->segment(1); ?>/kuis"><i class="fa fa-archive"></i> <span>Kuis</span></a></li>
            <li><a href="<?php echo base_url().$this->uri->segment(1); ?>/soal"><i class="fa fa-tasks"></i> <span>Soal</span></a></li>
            <!-- <li class="treeview"><a href="#"><i class="glyphicon glyphicon-wrench"></i> <span>Tambahan Poin</span><i class="fa fa-angle-left pull-right"></i></a>
               <ul class="treeview-menu">
              <?php
                $cek=$this->model_app->umenu_akses("poin",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/poin'><i class='fa fa-circle-o'></i>Tambah Poin Tambahan</a></li>";
                }

                $cek=$this->model_app->umenu_akses("riwayatpoin",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/riwayatpoin'><i class='fa fa-circle-o'></i>Riwayat Poin Tambahan</a></li>";
                }
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
              <?php
                $cek=$this->model_app->umenu_akses("sliderwebsie",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/sliderwebsite'><i class='fa fa-circle-o'></i> Slider Website</a></li>";
                }

                $cek=$this->model_app->umenu_akses("videowebsite",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/videowebsite'><i class='fa fa-circle-o'></i> Video Website</a></li>";
                }
                  $cek=$this->model_app->umenu_akses("popup",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/popup'><i class='fa fa-circle-o'></i> Popup Iklan</a></li>";
                }
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <?php 
                    ...
                    $cek=$this->model_app->umenu_akses("dropshipper",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url().$this->uri->segment(1)."/dropshipper'><i class='fa fa-circle-o'></i> Data Dropshipper</a></li>";
                    }
                    ...
                    if($cek==1 OR $this->session->level=='admin'){
                     ...
                     $cek=$this->model_app->umenu_akses("music",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url().$this->uri->segment(1)."/music'><i class='fa fa-circle-o'></i> Data Music</a></li>";
                   
                    }
                     $cek=$this->model_app->umenu_akses("angka",$this->session->id_session);
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url().$this->uri->segment(1)."/angka'><i class='fa fa-circle-o'></i> Data Tebak Angka</a></li>";
