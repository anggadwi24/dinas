  ...
  ?>
                    ...
                    <div class="row">
                      ...
                      ?>
                      <?php if($u > 0){?>
                            <a href="<?= base_url('administrator/editabsen/').$rows[id_absensi]?>" class="card-link m-2 float-left">Edit Absen</a>
                          <?php }?>
                          <?php if($d > 0){?>
                             <a href="<?= base_url('administrator/hapusabsen/').$rows[id_absensi]?>" class="card-link m-2 float-right">Hapus Absen</a>
                           <?php }?>
                          </div>
                        </div>
                      </div>
