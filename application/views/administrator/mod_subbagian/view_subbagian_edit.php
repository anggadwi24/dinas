                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Sub Bidang</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('administrator/sub_bagian/edit')?>" method="post">
                               <div class="row">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="col-md-6">
                                       <div class="form-group">
                                           <label>NIP Kepala Sub Bagian</label>
                                           <input type="text" name="nip" class="form-control" required value="<?= $rows['nip']?>">
                                       </div>
                                   </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                           <label>Pangkat Kepala Sub Bagian</label>
                                           <input type="text" name="pangkat" class="form-control" required value="<?= $rows['pangkat']?>">
                                       </div>
                                   </div>
