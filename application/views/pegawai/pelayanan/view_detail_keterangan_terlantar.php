	...
	<div class="container" data-aos="fade-up">
		<div class="row justfiy-content-center text-center">
			...
			<div class="col-12">
				 ...
				 <h6>Menumpang dikediaman : </h6>
				 <h6><?= $warga['nama_lengkap']?></h6>
				 <h6>Selama <?= $row['selama']?> hari</h6>
			</div>
			
		
			<div class="col-6 text-right "><a href="<?= base_url('pegawai/approve/keterangan_terlantar/').$row['id_kt'].'/id_kt'?>" class="text-success"><i class="ri-check-line" style="font-size: 30px"></i></a></div>
			 <div class="col-6 text-left"><a href="<?= base_url('pegawai/disapprove/keterangan_terlantar/').$row['id_kt'].'/id_kt'?>" class="text-danger"><i class="ri-close-line" style="font-size: 30px"></i></a></div>
		</div>
	</div>
</section>