<section id="about" class="about">
	<div class="container" data-aos="fade-up">
		<div class="row justfiy-content-center text-center">
			...
			<div class="col-6 text-right "><a href="<?= base_url('pegawai/approve/usaha_dom/').$row['id_usaha_dom'].'/id_usaha_dom'?>" class="text-success"><i class="ri-check-line" style="font-size: 30px"></i></a></div>
			 <div class="col-6 text-left"><a href="<?= base_url('pegawai/disapprove/usaha_dom/').$row['id_usaha_dom'].'/id_usaha_dom'?>" class="text-danger"><i class="ri-close-line" style="font-size: 30px"></i></a></div>
		</div>
	</div>
</section>