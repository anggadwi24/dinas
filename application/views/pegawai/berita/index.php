   <div class="container-fluid">
 	<div class="row">
 		...
 		<div class="col-lg-12 col-xs-12 col-sm-12 col-md-12 box-berita mx-auto">
 			<div class="float-left"><h2 style="color: white;">Berita </h2></div>
  ...
  <div class="container-fluid">
 	<div class="row">
 		<div class="col-lg-12 col-xs-12 col-sm-12 col-md-12 box-berita mx-auto float-right">
	        ...
	        ?>
	       <a href="<?= base_url('berita/search/kategori/').$kat['id_kategori']?>"><button type="button" class="<?= $btn ?>"><?= strtoupper($kat['nama_kategori']) ?></button></a>
	      <?php } ?>
