...
<body>
  ...
  $user = $this->model_app->view_where('pengawas',array('id_pengawas'=>$this->session->id_pengawas))->row_array();;
 ...
 <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-12 ">
          <h5 class="mb-4">Selamat Datang, <?= ucfirst($user['nama_lengkap'])?></h5>
          <h5><b><?= ucfirst($user['nama_lengkap'])?></b></h5>
          <label><?= ucfirst($user['jabatan'])?></label>
        </div>
