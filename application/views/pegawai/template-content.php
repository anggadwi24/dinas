 ...
 <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        ...
        <div class="col-4">
          <img src="<?= $pp?>" class="rounded-circle mt-4" style="width: 80px;height: 80px;" alt="Cinque Terre">
        </div>
      </div>
        ...
        if($abs->num_rows() > 0  AND $absen['absen_keluar']=="" ){
            ...
            <div class='row justify-content-center mt-5'>
              <div class='col-12 text-center'>
                <a href='".base_url('pegawai/inputabsen/').$absen['id_absensi']."' class='btn  text-light rounded-pill ' style='background-color: #e53f00 !important'>ABSEN KELUAR</a>
              </div>
            </div>";
           ...
           echo "   
            <div class='row justify-content-center mt-5'>
              <div class='col-12 text-center'>
                <a href='".base_url('pegawai/inputabsen/')."' class='btn  text-light rounded-pill ' style='background-color: #e53f00 !important'>ABSEN MASUK</a>
              </div>
            </div>";
        } 
        ?>
    ...
    <?php }?>
     <?php if($this->uri->segment('2')=='form'){ 
         ...
         echo "   
            <div class='row justify-content-center mt-5'>
              <div class='col-12 text-center'>
                <a href='".base_url('pegawai/inputform/')."' class='btn  text-light rounded-pill ' style='background-color: #e53f00 !important'>AJUKAN FORM</a>
              </div>
            </div>";
      }?> 
       <?php if($this->uri->segment('2')=='report'){ 
         ...
         echo "   
            <div class='row justify-content-center mt-5'>
              <div class='col-12 text-center'>
                <a href='".base_url('pegawai/inputreport/')."' class='btn  text-light rounded-pill ' style='background-color: #e53f00 !important'>TAMBAH REPORT</a>
              </div>
            </div>";
      }?> 
