            <div class="col-xs-12">  
              <div class="box">
                ...
                ?>
                  ...
                  <tr>
                    <form action="<?php echo base_url('reseller/kirim_pembelian')?>" method="post">
                    <td colspan="6"><input type="hidden" name="id_penjualan" value="<?= $id_penjualan?>"></td>
                    <td ><input type="submit" class="btn btn-primary" value="KIRIM"></td>
                  </form>
                  </tr>
                  </tbody>
                </table>
                <a class='btn btn-primary btn-sm' href='<?php echo base_url(); ?>reseller/pembelian'> Kembali</a>
                </div>
                </div>
                </div>
