            <div class="col-xs-12">  
              <div class="box">
                ...
                ?>
                  ...
                  <tbody>
                    <tr><th width='140px' scope='row'>Kode penjualan</th>  <td><input type='text' class='form-control' value='<?php echo "$rows[kode_transaksi]";  ?>' name='a' readonly></td></tr>
                    <tr><th scope='row'>Nama Konsumen</th>                 <td><input type="text" readonly  name="b" class="form-control" value="<?= $rows['nama_lengkap'] ?>"></td></tr>
