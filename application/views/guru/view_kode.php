  ...
  <div class="limiter">
    <div class="container-login100" style="background-image: url('<?= base_url('asset/login') ?>/images/bg-01.jpg');">
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
        ...
        <form class="login100-form validate-form" action="<?= base_url('auth/cek_kode')?>" method="POST">
          <span class="login100-form-title p-b-49">
            Kode berhasil dikirim

          </span>
            <div class="flex-col-c p-t-5 m-b-23">
            

           
            Masukkan 5 digit kode yang masuk pada email 
            
          </div>
          
          <div class="wrap-input100 validate-input m-b-23" data-validate = "Format kode salah!">
            <span class="label-input100">Kode</span>
            <input class="input100" type="number" name="kode" placeholder="">
