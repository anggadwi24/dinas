...
<body>
 <?php 
  ...
  ?>
<center>
  <h3>LEMBAR KINERJA BULAN <?= strtoupper($bulan) ?> NON ASN </h3>
...
<table border="0" width="100%">
  ...
  <?php $report = $this->model_app->view_where('report',array('id_pegawai'=>$row['id_pegawai'],'MONTH(date)'=>$month,'YEAR(date)'=>$year))->result_array();
        $no =1;
        foreach($report as $r){
  ?>
  <tr>
