 <section id="about" class="about">
      <div class="container" >
        ...
        <div class="row mt-3 justify-content-center"  >
          ...
          <div class="col-11 form-group">
                ...
                <input type="hidden" class="form-control" id="no_kk" placeholder=""  required="" value="<?= $row['no_kk']?>">
                <h6 class="text-center">No KK : <?= $row['no_kk']?></h6>
          </div>
          <div class="col-11 form-group">
             ...
             <label class="sr-only" for="rupiah">Nominal Pemasukan</label>
              <div class="input-group mb-2 mr-sm-2">
                ...
                <input type="text" class="form-control"  placeholder="" id="nama_kepala_keluarga" required="" value="<?= $row['nama_kepala_keluarga']?>">
              </div>
          </div>
          <div class="col-11 form-group">
             ...
             <label class="sr-only" for="rupiah">Nominal Pemasukan</label>
              <div class="input-group mb-2 mr-sm-2">
                ...
                <select class="form-control" id="kab">
                  ...
                  $kab = $this->model_app->view_where_ordering('kabupaten',array('id_prov'=>$row['provinsi']),'nama','ASC');
                  foreach($kab->result_array() as $kab){
                       if($row['kabupaten'] == $kab['id_kab']){
             ...
             <label class="sr-only" for="rupiah">Nominal Pemasukan</label>
              <div class="input-group mb-2 mr-sm-2">
                ...
                <select class="form-control" id="kec">
                  ...
                  $kec = $this->model_app->view_where_ordering('kecamatan',array('id_kab'=>$row['kabupaten']),'nama','ASC');
                  foreach($kec->result_array() as $kec){
                       if($row['kecamatan'] == $kec['id_kec']){
             ...
             <label class="sr-only" for="rupiah">Nominal Pemasukan</label>
              <div class="input-group mb-2 mr-sm-2">
                ...
                <select class="form-control" id="kel">
                  ...
                  $kel = $this->model_app->view_where_ordering('kelurahan',array('id_kec'=>$row['kecamatan']),'nama','ASC');
                  foreach($kel->result_array() as $kel){
           ...
           <div class="col-11 form-group">
             ...
             <label class="sr-only" for="rupiah">Nominal Pemasukan</label>
              <div class="input-group mb-2 mr-sm-2">
                ...
                <textarea class="form-control" id="alamat" required><?= $row['alamat'] ?></textarea>
              </div>
          </div>
           ...
           <div class="col-5 form-group ">
             ...
             <label class="sr-only" for="rupiah">Nominal Pemasukan</label>
              <div class="input-group mb-2 mr-sm-2">
                ...
                <input type="number" class="form-control"  placeholder="" id="kode_pos" value="<?= $row['kode_pos']?>">
              </div>
          </div>
          <div class="col-3 form-group ">
             ...
             <label class="sr-only" for="rupiah">Nominal Pemasukan</label>
              <div class="input-group mb-2 mr-sm-2">
                ...
                <input type="number" class="form-control"  placeholder="" id="rt" value="<?= $row['rt']?>">
              </div>
          </div>
          <div class="col-3 form-group ">
             ...
             <label class="sr-only" for="rupiah">Nominal Pemasukan</label>
              <div class="input-group mb-2 mr-sm-2">
                ...
                <input type="number" class="form-control"  placeholder="" id="rw" value="<?= $row['rw'] ?>" >
              </div>
          </div>
           
          <div class="col-11">
            <button id="btnNext" class="btn btn-primary w-100">UBAH</button>
          </div>
  ...
  <script type="text/javascript">
      ...
      var rw = $( "#rw" ).val();
       ...
       $.ajax({
         type: "POST",
         url: "<?= base_url('pegawai/do_updatekk')?>", 
