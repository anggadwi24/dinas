...
<form method="post" action="<?= base_url('guru/do_report')?>" enctype="multipart/form-data" onsubmit="$('#loader').show();">
            ...
            <div class="col-md-12">
             <div class="form-group">
                  <button type="submit" class="btn btn-danger col-12 my-3 text-light">TAMBAH REPORT</button>
              </div>
              </div>
              </div>
            </form>
