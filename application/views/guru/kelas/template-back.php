...
<head>
  ...
  <link href="<?php echo base_url(); ?>template/<?php echo base_theme(); ?>/assets/vendor/select2/select2.min.css" rel="stylesheet">
  ...
  <script src="<?php echo base_url(); ?>template/<?php echo base_theme(); ?>/assets/vendor/select2/select2.min.js"></script>
...
<body>
 ...
 <section id="hero1" class="d-flex align-items-center" style="padding-top:0 !important" >
     <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-12 mb-2  text-left">
          <h5>
             <a href="<?= $back ?>">
                  <i class="ri-arrow-left-s-line text-light" style="font-size: 30px;"></i>

            </a>
          </h5>
        </div>
       <div class="col-4">
           <img src="<?= $row['rk_icon'] ?>" class="img-fluid" srcset="" alt="">
       </div>
      <div class="col-8">
          <?php   $mapel = $this->model_app->view_where('mata_pelajaran',array('mapel_id'=>$row['rk_mapel']))->row_array(); ?>
        <h5 class="mb-0"><?= $judul?></h5>
        <span class="text-light"><?= $mapel['mapel']?> - <?= $row['rk_kelas'] ?></span>
      </div>
