<section id="about" class="about">
	<div class="container" data-aos="fade-up">
		<div class="row justfiy-content-center text-center">
			...
			<div class="col-6 text-right "><a href="<?= base_url('pegawai/approve/usaha/').$row['id_usaha'].'/id_usaha'?>" class="text-success"><i class="ri-check-line" style="font-size: 30px"></i></a></div>
			 <div class="col-6 text-left"><a href="<?= base_url('pegawai/disapprove/usaha/').$row['id_usaha'].'/id_usaha'?>" class="text-danger"><i class="ri-close-line" style="font-size: 30px"></i></a></div>
		</div>
	</div>
</section>