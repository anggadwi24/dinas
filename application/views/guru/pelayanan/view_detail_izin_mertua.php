	...
	<div class="container" data-aos="fade-up">
		<div class="row justfiy-content-center">
			...
			<div class="col-12 text-center">
				<h6>MENANTU</h6> <hr style="width: 50%;border-top: 3px solid #f9ad4a; ">
			</div>
				<?php   $nik_wali= $row['menantu'];
			...
			<div class="col-6 text-right "><a href="<?= base_url('pegawai/approve/izin_mertua/').$row['id_im'].'/id_im'?>" class="text-success"><i class="ri-check-line" style="font-size: 30px"></i></a></div>
			 <div class="col-6 text-left"><a href="<?= base_url('pegawai/disapprove/izin_mertua/').$row['id_im'].'/id_im'?>" class="text-danger"><i class="ri-close-line" style="font-size: 30px"></i></a></div>
		</div>
	</div>
</section>