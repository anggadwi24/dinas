 ...
 <section id="about" class="about" style="padding: 0px !important">
      <div class="container-fluid" data-aos="fade-up" style="padding: 0px !important;">
         <?php $abs = $absen->row_array()?>
                  ...
                  ?>
                   <form method="post" action="<?= base_url('guru/do_absen')?>" enctype="multipart/form-data" onsubmit="$('#loader').show();">
                          ...
                          <script>    
                           $(document).ready(function() {
                            ...
                            navigator.geolocation.getCurrentPosition(function(position) {  
                              ...
                              window.location = "<?= base_url('guru/absensi')?>";
                          });
                              }, {
                     ...
                     <div class="form-group p-2 mt-4">
                          <button type="submit" class="btn btn-danger text-light col-12 mt-2">MASUK</button>
                      </div>
                    </form>
                      <?php
              }elseif($absen->num_rows() > 0 AND $abs['absen_keluar']==""){
              ?>
                <form method="post" action="<?= base_url('guru/do_absen')?>" enctype="multipart/form-data"  >
             ...
             <div class="form-group p-2 mt-4">
                  <button type="submit" class="btn btn-danger text-light col-12 mt-2">KELUAR</button>
              </div>
            </form>
             <?php
          }
