<style type="text/css">
  input[readonly="readonly"] {
      outline: 0;border-width: 0 0 2px;border-color: #e53f00;background-color: white!important;
}
<?php  
      ...
      <div class="container-fluid" data-aos="fade-up" >
              ...
              <div class="row"> 
                <div class="col-12">
                  ...
                  <div> <hr style="width: 100%;border-top: 1px solid #e53f00; "></div>
                </div>
              </div>
              <form method="post" action="<?= base_url('guru/do_form')?>" enctype="multipart/form-data" onsubmit="$('#loader').show();" id="sakit">
              <div class="row">
                <div class="col-12">
                   <h1 class="text-center" style="color:#e53f00;">Form Sakit</h1>
            ...
            <div class="col-md-12">
             <div class="form-group">
                  <button type="submit" class="btn btn-danger col-12 my-3 text-light">AJUKAN</button>
              </div>
              </div>
              </div>
             ...
             <form method="post" action="<?= base_url('guru/do_form')?>" enctype="multipart/form-data" onsubmit="$('#loader').show();" id="ijin">
              <div class="row">
                <div class="col-12">
                  <h1 class="text-center" style="color:#e53f00;">Form Ijin</h1>
                   <hr style="width: 50%;border-top: 3px solid #e53f00; ">
                </div>
                <!--  <div class="col-12">
                  <div class="form-group">
