<form action="<?= base_url('home/add_ekonomi_lemah')?>" method="POST">
<div class="row justfiy-content-center">
<div class="col-12">
	<div class="section-title">
	<h2>FORM SURAT KETERANGAN EKONOMI LEMAH</h2>
</div>
</div>
...
<div class="col-12 form-group">
	<label>Untuk</label>
	<input type="text" name="untuk" id="untuk" class="form-control" required onfocus="dataAnggota2()">
</div>
