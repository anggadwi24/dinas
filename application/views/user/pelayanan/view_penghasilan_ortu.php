<form action="<?= base_url('home/add_penghasilan_ortu')?>" method="POST">
<div class="row justfiy-content-center">
<div class="col-12">
	<div class="section-title">
	<h2>FORM SURAT KETERANGAN  PENGHASILAN ORANG TUA</h2>
</div>
</div>
...
<div class="col-12 form-group">
	...
	<input type="text" name="keperluan" id="untuk" class="form-control" required >
</div>
<div class="col-12 form-group">
             ...
             <label class="sr-only" for="rupiah">Nominal Pemasukan</label>
              <div class="input-group mb-2 mr-sm-2">
                <div class="input-group-prepend">
                  <div class="input-group-text text-dark bg-white" >± </div>
                </div>
                <input type="number" class="form-control"  placeholder="" id="nama_kepala_keluarga"  name="penghasilan" required="">
              </div>
</div>
<div class="col-12">
...
<div class="col-12 text-center">
	<h2>Orang tua dari :</h2>
</div>
<div class="col-12 form-group">
	<label>NIK</label>
	<input type="number" name="nik1" id="nik_ayah" class="form-control" required>
</div>
<div class="col-12 form-group">
	<label>Nama</label>
	<input type="text" name="nama1" id="nama_ayah" class="form-control" required  onfocus="dataAnggotaA()">
</div>
