 ...
 <section id="hero1" class="d-flex align-items-center" style="padding:20px !important" >
     <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="col-12  mt-3 text-center">
        <h5 style="color: white" class=" ">KELURAHAN DHARMA </h5>
      </div>
      <div class="col-12 mt-1 text-center">
        <h2><?= strtoupper(hari_ini(date('w')));?> </h2>
        <?php if($oper->num_rows() > 0){
          $hk = $oper->row_array();
          ?>
         <small class="d-block text-light">JAM OPERASIONAL</small>
        <label><?= date('H:i',strtotime($hk['shift_masuk'])).' - '.date('H:i',strtotime($hk['shift_keluar']))?></label>
      <?php }else{?>
         <small class="d-block text-light">TUTUP</small>
      <?php }?>
      </div>
  </div>
</div>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left text-lg-center">
        <div class="copyright">
          &copy; Copyright <strong><span>KELURAHAN DHARMA</span></strong>
