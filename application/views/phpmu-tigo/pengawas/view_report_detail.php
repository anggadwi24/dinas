    ...
    <!-- ======= About Section ======= -->
     <section id="about" class="about" >
      <div class="container" data-aos="fade-up" >
       ...
       <?php $peg = $this->model_app->view_where('pegawai',array('id_pegawai'=>$row['id_pegawai']))->row_array(); ?>
<?php if($row['finish']=='n'){ ?>
<form method="post" action="<?= base_url('pengawas/updatereport')?>" enctype="multipart/form-data" onsubmit="$('#loader').show();">
          
              <div class="row">
                 <div class="col-md-12">
                <div class="form-group">
                  <label>Pegawai</label>
                  <input type="text" name="pegawai" class="form-control" readonly  value="<?= $peg['nama_lengkap']?>">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="id" class="form-control" required value="<?= $row['id_report']?>">
                   <input type="hidden" name="id_pegawai" class="form-control" required value="<?= $row['id_pegawai']?>">
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
            ...
            <div class="col-md-12">
             <div class="form-group">
                  <button type="submit" class="btn btn-warning col-12 my-3 text-light">UPDATE REPORT</button>
              </div>
              </div>
              </div>
            </form>
          ...
          <div class="row text-center">
            <div class="col-12">
                <div class="form-group"><h4><?= ucfirst($peg['nama_lengkap'])?></h4><label>Nama Pegawai</label></div>
              </div>
              <div class="col-12">
              ...
              <div class="col-12">
               ...
               <?php
                    if (file_exists("asset/foto_report/".$row['foto_masuk'])) { 
                        if ($row['foto_masuk']==''){
                           ?>
                           ...
                           ?>
                             ...
                             <div class="card col-6" style="width: 18rem;">
                               <div class="form-group">
                              <label>Foto Masuk</label>
                              <img class="card-img-top" src="<?= base_url('asset/foto_report/').$row['foto_masuk']?>" alt="Card image cap">
                            </div>
                             </div>
                          <?php }?>
             ...
             <?php }?>
             <?php
                    if (file_exists("asset/foto_report/".$row['foto_keluar'])) { 
                        if ($row['foto_keluar']==''){
                           ?>
                           <div class="card col-6" style="width: 18rem;">
                            <div class="form-group">
                           ...
                           ?>
                             ...
                             <div class="card col-6" style="width: 18rem;">
                               <div class="form-group">
                              <label>Foto Keluar</label>
                              <img class="card-img-top" src="<?= base_url('asset/foto_report/').$row['foto_keluar']?>" alt="Card image cap">
                            </div>
                             </div>
                          <?php }?>
