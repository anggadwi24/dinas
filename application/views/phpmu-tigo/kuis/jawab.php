   ...
   <div class="container-fluid">
    <div class="row">
        ...
        ?>
        <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12  mx-auto"><a href="<?= base_url('kuis/index/50')?>" class="text-white btn"  style="font-size:4rem"><i class="fas fa-arrow-circle-left mr-2"></i>KEMBALI</a></div>
