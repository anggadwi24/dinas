  ...
  <div class="container-fluid">
    <div class="row">
     ...
     <?php 
              ...
              ?>
<form action="<?= base_url('tigaangka/add_tebak')?>" method="POST">
<div class="container-fluid">
    <div class="row">

      <div class="col-lg-4 col-xs-4 col-sm-4 col-md-4 box2 mx-auto">
        <div class="d-flex justify-content-center font-aur-h1">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12 box-full mx-auto bergetar">
        ...
        <div class="d-flex justify-content-center font-aur">
       <input type="submit" name="submit" class="sbm" tabindex=4 value="TEBAK" <?php  if(date('H:i:s') >= $cek OR !isset($sesi)){echo "disabled";} ?>  >
        </div>
        ...
        <div class="d-flex justify-content-center font-aur" >
         ...
         <?php foreach($his->result_array() as $h){?>
                  ...
                  <?php if($row['angka'] == $h['tebak']){?>
                          <?php $benar = 1;?>
                          <center><h1 style="color: green;margin-right: 10px;" title="Tebakan Anda Benar"><?= $h['tebak']?></h1></center>
