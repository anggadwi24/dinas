<div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12 box-full mx-auto bergetar">
        <a href="<?=  base_url('duaangka/tebak')?>" style="text-decoration: none;">
     ...
     <!--  <div class="col-lg-6 col-xs-6 col-sm-6 col-md-6  box mx-auto">
        <a href="<?=  base_url('kuis/index/50')?>" style="text-decoration: none;">
        <div class="d-flex justify-content-center font-aur-h1">
        <h1>50</h1>
        </div>
        <div class="d-flex justify-content-center font-aur-h1">
