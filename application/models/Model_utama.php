...
class Model_utama extends CI_model{
    ...
    public function view_joinn($table1,$table2,$table3,$field,$field1,$order,$ordering,$baris,$dari){
     ...
     public function view_joinn_where($table1,$table2,$table3,$field,$field1,$order,$ordering,$baris,$dari,$where){
        $this->db->select('*');
        $this->db->from($table1);
        $this->db->join($table2, $table1.'.'.$field.'='.$table2.'.'.$field);
        $this->db->join($table3, $table1.'.'.$field1.'='.$table3.'.'.$field1);
        ...
        return $this->db->get();
         ...
         public function view_joinn_like($table1,$table2,$table3,$field,$field1,$order,$ordering,$baris,$dari,$like){
        $this->db->select('*');
        $this->db->from($table1);
        $this->db->join($table2, $table1.'.'.$field.'='.$table2.'.'.$field);
        $this->db->join($table3, $table1.'.'.$field1.'='.$table3.'.'.$field1);
